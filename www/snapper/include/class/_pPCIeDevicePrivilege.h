//---------------------------------------------------------------------
// <copyright file="_pPCIeDevicePrivilege.h" company="Lenovo">
...
class _pPCIeDevicePrivilege: public SnapperPrivilege
{
public:
    _pPCIeDevicePrivilege(): SnapperPrivilege("PCIeDevice")
    {
