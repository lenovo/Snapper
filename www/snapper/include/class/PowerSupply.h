...
//---------------------------------------------------------------------
#pragma once 
#include "class/_pPowerSupply.h"

namespace snapper { namespace providers 
{

class PowerSupply : public _pPowerSupply
{
public:
    PowerSupply() : _pPowerSupply()    
    {}
...
private:
    ...
    void SetRelatedItems(std::string className, std::string propName);
};
