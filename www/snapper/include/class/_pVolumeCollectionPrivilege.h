//---------------------------------------------------------------------
// <copyright file="_pVolumeCollectionPrivilege.h" company="Lenovo">
...
class _pVolumeCollectionPrivilege: public SnapperPrivilege
{
public:
    _pVolumeCollectionPrivilege(): SnapperPrivilege("VolumeCollection")
    {
    ...
    virtual ~_pVolumeCollectionPrivilege() 
    {}
