//---------------------------------------------------------------------
// <copyright file="_pSimpleStoragePrivilege.h" company="Lenovo">
...
class _pSimpleStoragePrivilege: public SnapperPrivilege
{
public:
    _pSimpleStoragePrivilege(): SnapperPrivilege("SimpleStorage")
    {
    ...
    virtual ~_pSimpleStoragePrivilege() 
    {}
