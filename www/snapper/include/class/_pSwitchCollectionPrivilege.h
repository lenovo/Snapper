//---------------------------------------------------------------------
// <copyright file="_pSwitchCollectionPrivilege.h" company="Lenovo">
...
class _pSwitchCollectionPrivilege: public SnapperPrivilege
{
public:
    _pSwitchCollectionPrivilege(): SnapperPrivilege("SwitchCollection")
    {
    ...
    virtual ~_pSwitchCollectionPrivilege() 
    {}
