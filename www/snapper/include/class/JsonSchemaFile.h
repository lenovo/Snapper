//---------------------------------------------------------------------
// <copyright file="JsonSchemaFile.h" company="Lenovo">
//        Copyright (c) 2018-present, Lenovo. All rights reserved. Licensed under BSD, see COPYING.BSD file for details.
// </copyright>
//---------------------------------------------------------------------
#pragma once 
#include "class/_pJsonSchemaFile.h"

namespace snapper { namespace providers 
{

class JsonSchemaFile : public _pJsonSchemaFile
{
public:
    
    JsonSchemaFile() : _pJsonSchemaFile()    
    {}

    virtual ~JsonSchemaFile()    
    {}    
