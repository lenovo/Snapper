//---------------------------------------------------------------------
// <copyright file="_pMessageRegistryPrivilege.h" company="Lenovo">
...
class _pMessageRegistryPrivilege: public SnapperPrivilege
{
public:
    _pMessageRegistryPrivilege(): SnapperPrivilege("MessageRegistry")
    {
    ...
    virtual ~_pMessageRegistryPrivilege() 
    {}
