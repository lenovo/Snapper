//---------------------------------------------------------------------
// <copyright file="ProcessorCollection.h" company="Lenovo">
//        Copyright (c) 2018-present, Lenovo. All rights reserved. Licensed under BSD, see COPYING.BSD file for details.
// </copyright>
//---------------------------------------------------------------------
#pragma once 

#include "class/_pProcessorCollection.h"

namespace snapper { namespace providers 
{

class ProcessorCollection : public _pProcessorCollection
{
public:
    ProcessorCollection() : _pProcessorCollection()    
    {}

    virtual ~ProcessorCollection()    
    {}
