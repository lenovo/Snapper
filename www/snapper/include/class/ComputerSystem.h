...
//---------------------------------------------------------------------
#pragma once 
#include "class/_pComputerSystem.h"

namespace snapper { namespace providers 
{

class ComputerSystem : public _pComputerSystem
{
public:
    
    ComputerSystem() : _pComputerSystem()    
    {}
...
private:
    ...
    void build_all_objs(const string oid, bson::BSONObj & obj);
};
