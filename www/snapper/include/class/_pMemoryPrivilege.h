//---------------------------------------------------------------------
// <copyright file="_pMemoryPrivilege.h" company="Lenovo">
...
class _pMemoryPrivilege: public SnapperPrivilege
{
public:
    _pMemoryPrivilege(): SnapperPrivilege("Memory")
    {
