//---------------------------------------------------------------------
// <copyright file="_pZonePrivilege.h" company="Lenovo">
...
class _pZonePrivilege: public SnapperPrivilege
{
public:
    _pZonePrivilege(): SnapperPrivilege("Zone")
    {
