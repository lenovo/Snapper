//---------------------------------------------------------------------
// <copyright file="_pMemoryMetricsPrivilege.h" company="Lenovo">
...
class _pMemoryMetricsPrivilege: public SnapperPrivilege
{
public:
    _pMemoryMetricsPrivilege(): SnapperPrivilege("MemoryMetrics")
    {
    ...
    virtual ~_pMemoryMetricsPrivilege() 
    {}
