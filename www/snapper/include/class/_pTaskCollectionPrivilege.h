//---------------------------------------------------------------------
// <copyright file="_pTaskCollectionPrivilege.h" company="Lenovo">
...
class _pTaskCollectionPrivilege: public SnapperPrivilege
{
public:
    _pTaskCollectionPrivilege(): SnapperPrivilege("TaskCollection")
    {
    ...
    virtual ~_pTaskCollectionPrivilege() 
    {}
