//---------------------------------------------------------------------
// <copyright file="_pEndpointPrivilege.h" company="Lenovo">
...
class _pEndpointPrivilege: public SnapperPrivilege
{
public:
    _pEndpointPrivilege(): SnapperPrivilege("Endpoint")
    {
