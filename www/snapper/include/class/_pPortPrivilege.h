//---------------------------------------------------------------------
// <copyright file="_pPortPrivilege.h" company="Lenovo">
...
class _pPortPrivilege: public SnapperPrivilege
{
public:
    _pPortPrivilege(): SnapperPrivilege("Port")
    {
