//---------------------------------------------------------------------
// <copyright file="_pStorageCollectionPrivilege.h" company="Lenovo">
...
class _pStorageCollectionPrivilege: public SnapperPrivilege
{
public:
    _pStorageCollectionPrivilege(): SnapperPrivilege("StorageCollection")
    {
    ...
    virtual ~_pStorageCollectionPrivilege() 
    {}
