//---------------------------------------------------------------------
// <copyright file="MessageRegistryFileCollection.h" company="Lenovo">
//        Copyright (c) 2018-present, Lenovo. All rights reserved. Licensed under BSD, see COPYING.BSD file for details.
// </copyright>
//---------------------------------------------------------------------
#pragma once 

#include "class/_pMessageRegistryFileCollection.h"

namespace snapper { namespace providers 
{

class MessageRegistryFileCollection : public _pMessageRegistryFileCollection
{
public:
    MessageRegistryFileCollection() : _pMessageRegistryFileCollection()    
    {}
