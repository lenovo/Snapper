//---------------------------------------------------------------------
// <copyright file="EthernetInterface.h" company="Lenovo">
//        Copyright (c) 2018-present, Lenovo. All rights reserved. Licensed under BSD, see COPYING.BSD file for details.
// </copyright>
//---------------------------------------------------------------------
#pragma once 
#include "class/_pEthernetInterface.h"

namespace snapper { namespace providers 
{

class EthernetInterface : public _pEthernetInterface
{
public:
    EthernetInterface() : _pEthernetInterface()    
    {}
