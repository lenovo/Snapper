//---------------------------------------------------------------------
// <copyright file="_pMemoryDomainPrivilege.h" company="Lenovo">
...
class _pMemoryDomainPrivilege: public SnapperPrivilege
{
public:
    _pMemoryDomainPrivilege(): SnapperPrivilege("MemoryDomain")
    {
    ...
    virtual ~_pMemoryDomainPrivilege() 
    {}
