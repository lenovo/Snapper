//---------------------------------------------------------------------
// <copyright file="_pFabricCollectionPrivilege.h" company="Lenovo">
...
class _pFabricCollectionPrivilege: public SnapperPrivilege
{
public:
    _pFabricCollectionPrivilege(): SnapperPrivilege("FabricCollection")
    {
    ...
    virtual ~_pFabricCollectionPrivilege() 
    {}
