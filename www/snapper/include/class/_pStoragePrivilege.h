//---------------------------------------------------------------------
// <copyright file="_pStoragePrivilege.h" company="Lenovo">
...
class _pStoragePrivilege: public SnapperPrivilege
{
public:
    _pStoragePrivilege(): SnapperPrivilege("Storage")
    {
