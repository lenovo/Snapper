//---------------------------------------------------------------------
// <copyright file="_pJsonSchemaFilePrivilege.h" company="Lenovo">
...
class _pJsonSchemaFilePrivilege: public SnapperPrivilege
{
public:
    _pJsonSchemaFilePrivilege(): SnapperPrivilege("JsonSchemaFile")
    {
    ...
    virtual ~_pJsonSchemaFilePrivilege() 
    {}
