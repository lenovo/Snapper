//---------------------------------------------------------------------
// <copyright file="_pDrivePrivilege.h" company="Lenovo">
...
class _pDrivePrivilege: public SnapperPrivilege
{
public:
    _pDrivePrivilege(): SnapperPrivilege("Drive")
    {
