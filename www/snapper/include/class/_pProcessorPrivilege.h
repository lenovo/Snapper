//---------------------------------------------------------------------
// <copyright file="_pProcessorPrivilege.h" company="Lenovo">
...
class _pProcessorPrivilege: public SnapperPrivilege
{
public:
    _pProcessorPrivilege(): SnapperPrivilege("Processor")
    {
