//---------------------------------------------------------------------
// <copyright file="_pLogEntryPrivilege.h" company="Lenovo">
...
class _pLogEntryPrivilege: public SnapperPrivilege
{
public:
    _pLogEntryPrivilege(): SnapperPrivilege("LogEntry")
    {
