...
#define ODATA_TRACE_X(x)       (std::cout << "[" <<  __FILENAME__ << ":" << __LINE__ << ":" << __FUNCTION__ << "]" << x)
#define ODATA_TRACE_Y(x)       (std::cout << x)
#define ODATA_TRACE_V(x)       std::cout << "[" <<  __FILENAME__ << ":" << __LINE__ << ":" << __FUNCTION__ << "]:" << x << std::endl
#define ODATA_TRACE       std::cout << "[" <<  __FILENAME__ << ":" << __LINE__ << ":" << __FUNCTION__ << "]" << std::endl
}}
