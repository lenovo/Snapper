...
private:
    ...
    bool try_bind_Oem_as_declared_property(const ::odata::utility::string_t &identifier, const ::odata::utility::string_t &key_exp);
    bool try_bind_as_exception(const ::odata::utility::string_t &identifier, const ::odata::utility::string_t &key_exp);
    bool try_bind_as_type(const ::odata::utility::string_t &identifier, const ::odata::utility::string_t &empty_exp, bool ignore_prop_check = false);
    bool try_bind_as_operation(const ::odata::utility::string_t &identifier, const ::odata::utility::string_t &parameters_exp);
    bool try_bind_as_key_of_collection(const ::odata::utility::string_t &identifier, const ::odata::utility::string_t &empty_exp);    
    bool try_bind_as_key_of_resource_collection(const ::odata::utility::string_t &identifier, const ::odata::utility::string_t &empty_exp);
