//---------------------------------------------------------------------
// <copyright file="PCIeDevice.cpp" company="Lenovo">
//        Copyright (c) 2018-present, Lenovo. All rights reserved. Licensed under BSD, see COPYING.BSD file for details.
// </copyright>
//---------------------------------------------------------------------
#include "class/PCIeDevice.h"
...
std::shared_ptr<memid_acckey_map> PCIeDevice::getlist_memid_acckey(std::string containing_path)
{
    ...
    {
        (*list)[m[i]] = std::string(m[i])+"@"+"PCIeDevice";
    }
    return list;
...
int PCIeDevice::handle_get(shared_ptr<::snapper::service::request_context> request)
{
...
int PCIeDevice::handle_post(shared_ptr<::snapper::service::request_context> request)
{
    return RFRC_METHOD_NOT_ALLOWED;
}

int PCIeDevice::handle_patch(shared_ptr<::snapper::service::request_context> request)
{
    return RFRC_METHOD_NOT_ALLOWED;
}

int PCIeDevice::handle_put(shared_ptr<::snapper::service::request_context> request)
{
    return RFRC_METHOD_NOT_ALLOWED;
}

int PCIeDevice::handle_delete(shared_ptr<::snapper::service::request_context> request)
{
    return RFRC_METHOD_NOT_ALLOWED;
}

REGISTER_PROVIDER(PCIeDevice);
}}
