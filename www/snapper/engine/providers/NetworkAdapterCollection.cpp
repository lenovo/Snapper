//---------------------------------------------------------------------
// <copyright file="NetworkAdapterCollection.cpp" company="Lenovo">
//        Copyright (c) 2018-present, Lenovo. All rights reserved. Licensed under BSD, see COPYING.BSD file for details.
// </copyright>
//---------------------------------------------------------------------
#include "class/NetworkAdapterCollection.h"
...
int NetworkAdapterCollection::handle_get(shared_ptr<::snapper::service::request_context> request)
{ 
    ...
    if(prop_in)
    {
        return access_member_prop(prop_in, "NetworkAdapter");
    }
...
int NetworkAdapterCollection::handle_post(shared_ptr<::snapper::service::request_context> request)
{
    return RFRC_METHOD_NOT_ALLOWED;
}


REGISTER_PROVIDER(NetworkAdapterCollection);
}}
