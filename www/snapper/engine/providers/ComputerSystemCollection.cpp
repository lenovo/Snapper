//---------------------------------------------------------------------
// <copyright file="ComputerSystemCollection.cpp" company="Lenovo">
//        Copyright (c) 2018-present, Lenovo. All rights reserved. Licensed under BSD, see COPYING.BSD file for details.
// </copyright>
//---------------------------------------------------------------------
#include "class/ComputerSystemCollection.h"
...
int ComputerSystemCollection::handle_get(shared_ptr<::snapper::service::request_context> request)
{ 
    ...
    if(prop_in)
    {
        return access_member_prop(prop_in, "ComputerSystem");
    }
...
int ComputerSystemCollection::handle_post(shared_ptr<::snapper::service::request_context> request)
{
...
REGISTER_PROVIDER(ComputerSystemCollection)
