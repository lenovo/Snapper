//---------------------------------------------------------------------
// <copyright file="Memory.cpp" company="Lenovo">
...
static map<string, DimmMapStruct*> PlatformMap;
...
std::shared_ptr<memid_acckey_map> Memory::getlist_memid_acckey(std::string containing_path)
{
    ...
    {
        (*list)[m[i]] = std::string(m[i])+"@"+"Memory";
    }
    return list;

}

int Memory::handle_get(shared_ptr<::snapper::service::request_context> request)
{
...
int Memory::handle_post(shared_ptr<::snapper::service::request_context> request)
{
    return RFRC_METHOD_NOT_ALLOWED;
}

int Memory::handle_patch(shared_ptr<::snapper::service::request_context> request)
{
    return RFRC_METHOD_NOT_ALLOWED;
}

int Memory::handle_put(shared_ptr<::snapper::service::request_context> request)
{
    return RFRC_METHOD_NOT_ALLOWED;
}

int Memory::handle_delete(shared_ptr<::snapper::service::request_context> request)
{
    return RFRC_METHOD_NOT_ALLOWED;
}
