//---------------------------------------------------------------------
// <copyright file="NetworkInterface.cpp" company="Lenovo">
//        Copyright (c) 2018-present, Lenovo. All rights reserved. Licensed under BSD, see COPYING.BSD file for details.
// </copyright>
//---------------------------------------------------------------------
#include "class/NetworkInterface.h"
...
std::shared_ptr<memid_acckey_map> NetworkInterface::getlist_memid_acckey(std::string containing_path)
{
    ...
    {
        (*list)[m[i]] = std::string(m[i])+"@"+"NetworkInterface";
    }
    return list;

}

int NetworkInterface::handle_get(shared_ptr<::snapper::service::request_context> request)
{
...
int NetworkInterface::navigation_property_query(shared_ptr<::snapper::service::request_context> request)
{
    return RFRC_SUCCESS;
}

int NetworkInterface::handle_post(shared_ptr<::snapper::service::request_context> request)
{
    return RFRC_METHOD_NOT_ALLOWED;
}

int NetworkInterface::handle_patch(shared_ptr<::snapper::service::request_context> request)
{    
...
int NetworkInterface::handle_put(shared_ptr<::snapper::service::request_context> request)
{
    return RFRC_METHOD_NOT_ALLOWED;
}

int NetworkInterface::handle_delete(shared_ptr<::snapper::service::request_context> request)
{
    return RFRC_METHOD_NOT_ALLOWED;
}


REGISTER_PROVIDER(NetworkInterface);
