//---------------------------------------------------------------------
// <copyright file="Processor.cpp" company="Lenovo">
...
{
std::shared_ptr<memid_acckey_map> Processor::getlist_memid_acckey(std::string containing_path)
{
    ...
    {
        (*list)[m[i]] = std::string(m[i])+"@"+"Processor";
    }
    return list;

}

int Processor::handle_get(shared_ptr<::snapper::service::request_context> request)
{
...
int Processor::handle_post(shared_ptr<::snapper::service::request_context> request)
{
    return RFRC_METHOD_NOT_ALLOWED;
}

int Processor::handle_patch(shared_ptr<::snapper::service::request_context> request)
{
    return RFRC_METHOD_NOT_ALLOWED;
}

int Processor::handle_put(shared_ptr<::snapper::service::request_context> request)
{
    return RFRC_METHOD_NOT_ALLOWED;
}

int Processor::handle_delete(shared_ptr<::snapper::service::request_context> request)
{
    return RFRC_METHOD_NOT_ALLOWED;
}
