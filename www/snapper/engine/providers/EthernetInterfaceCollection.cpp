//---------------------------------------------------------------------
// <copyright file="EthernetInterfaceCollection.cpp" company="Lenovo">
//        Copyright (c) 2018-present, Lenovo. All rights reserved. Licensed under BSD, see COPYING.BSD file for details.
// </copyright>
//---------------------------------------------------------------------
#include "class/EthernetInterfaceCollection.h"
...
int EthernetInterfaceCollection::handle_get(shared_ptr<::snapper::service::request_context> request)
{ 
...
int EthernetInterfaceCollection::handle_post(shared_ptr<::snapper::service::request_context> request)
{
...
REGISTER_PROVIDER(EthernetInterfaceCollection);
}}
