//---------------------------------------------------------------------
// <copyright file="NetworkAdapter.cpp" company="Lenovo">
//        Copyright (c) 2018-present, Lenovo. All rights reserved. Licensed under BSD, see COPYING.BSD file for details.
// </copyright>
//---------------------------------------------------------------------
#include "class/NetworkAdapter.h"
...
std::shared_ptr<memid_acckey_map> NetworkAdapter::getlist_memid_acckey(std::string containing_path)
{
    ...
    {
        (*list)[m[i]] = std::string(m[i])+"@"+"NetworkAdapter";
    }
    return list;
...
int NetworkAdapter::handle_get(shared_ptr<::snapper::service::request_context> request)
{
...
int NetworkAdapter::navigation_property_query(shared_ptr<::snapper::service::request_context> request)
{
    return RFRC_SUCCESS;
}

int NetworkAdapter::handle_post(shared_ptr<::snapper::service::request_context> request)
{
    return RFRC_METHOD_NOT_ALLOWED;
}

int NetworkAdapter::handle_patch(shared_ptr<::snapper::service::request_context> request)
{    
    return handle_get(request);
}

int NetworkAdapter::handle_put(shared_ptr<::snapper::service::request_context> request)
{
    return RFRC_METHOD_NOT_ALLOWED;
}

int NetworkAdapter::handle_delete(shared_ptr<::snapper::service::request_context> request)
{
    return RFRC_METHOD_NOT_ALLOWED;
}


REGISTER_PROVIDER(NetworkAdapter);
